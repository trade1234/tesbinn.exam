...
export function drawCertificate(canvas, c, logo, qr) {
  ...
  ctx.textAlign="center";ctx.strokeStyle="#64748b";ctx.lineWidth=1;ctx.beginPath();ctx.moveTo(340,900);ctx.lineTo(660,900);ctx.stroke();ctx.fillStyle="#13294b";ctx.font="italic 25px Georgia";ctx.fillText(c.signatoryName||"Authorized Certification Officer",500,890,300);ctx.font="16px Arial";ctx.fillStyle="#64748b";ctx.fillText("Digitally Signed & Verified",500,925);
  ...
  if(qr){ctx.fillStyle="#ffffff";ctx.strokeStyle="#d7e5f5";ctx.lineWidth=2;ctx.beginPath();ctx.roundRect(742,842,116,116,10);ctx.fill();ctx.stroke();ctx.drawImage(qr,750,850,100,100);ctx.textAlign="center";ctx.fillStyle="#0754ad";ctx.font="700 13px Arial";ctx.fillText("SCAN TO VERIFY",800,980);}
